...
const Notification = ({
  ...
  const Icon = success ? (
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#288f24ff" width="800px" height="800px" viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="20" height="20" viewBox="0 0 36 36">
        <circle cx="18" cy="18" r="16" stroke="red" stroke-width="2" fill="none" />
        <line x1="12" y1="12" x2="24" y2="24" stroke="red" stroke-width="2" stroke-linecap="round" />
        <line x1="24" y1="12" x2="12" y2="24" stroke="red" stroke-width="2" stroke-linecap="round" />
      </svg>
  );
